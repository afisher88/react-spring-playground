...
function (_Component) {
  ...
  function Sidepane() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(Sidepane).apply(this, arguments));
  }
  ...
  return Sidepane;
}(react__WEBPACK_IMPORTED_MODULE_0__["Component"]); // export default function Sidepane({ activeRowIndex, tableData, hasUpdated }) {
...
//# sourceMappingURL=mount-unmount.js.03d61cd31348c59485a3.hot-update.js.map